...
class MallDaily extends TimeModel
{
    ...
    public function getPidMenuList($time)
    {

        $where[] = ['create_time', '>=', strtotime(date('Y-m-d',strtotime($time)).' 00:00:00')];
        $where[] = ['create_time', '<=', strtotime(date('Y-m-d',strtotime($time)).' 23:59:59')];
